...
export const metadata = {
  title: "AVV | Éclat de Noor",
  description: "Informationen zum Auftragsverarbeitungsvertrag nach Art. 28 DSGVO für Éclat de Noor.",
};

export default function AvvPage() {
  const copy = legalCopy.avv;
  return (
    <main className="min-h-screen bg-[#f5f0e8] px-6 py-16 text-[#2a1b14]">
      <section className="mx-auto max-w-3xl rounded-3xl bg-[#fbf7f0]/90 p-8 shadow-warm">
        ...
        <a className="mt-8 inline-flex rounded-full bg-[#3b261d] px-5 py-3 text-sm font-semibold text-[#ead6c1]" href="/avv" aria-disabled="true">
          AVV-Muster folgt als Download
        </a>
      </section>
    </main>
  );
